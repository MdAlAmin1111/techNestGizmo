        ...
        <div className='max-w-[1280px] mx-auto  bg-gray-50'>
            ...
            <div className='flex justify-between items-center py-2 px-10 flex-wrap'>
                ...
                <div className='flex gap-2 items-center'>
                    ...
                    <p className='text-2xl font-bold text-[#155e75]'>info@technestgizmo.com</p>
                </div>
                <div className='flex gap-2 items-center'>
                    <MapPin color="#155e75" size={30}/>
                    <p className='text-2xl font-bold text-[#155e75]'>128 Main Street <br />Dhaka, Bangladesh</p>
                </div>
            </div>
            <hr className='text-[#812c3060]'/>
            <div className='py-4 px-10 text-[#155e75] font-bold text-base'>
